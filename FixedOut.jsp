				...
				out.write("<input type='hidden' name='hvalue' value='"+(request.getAttribute("value")!=null?request.getAttribute("value").toString():"")+"' />");
                		if(list!=null) //循环数据列表，生成表格行
                		{
                			for(int i=0;i<list.size();i++)
	                		{
	               				...
	               				out.print("<tr><td align='center'>"+obj[0]+"</td><td align='center'>"+obj[1]+"</td><td align='center'>"+obj[7]+"</td><td align='center'>"+obj[6]+"</td><td align='center'>"+obj[2]+" "+obj[3]+"</td><td align='center'>"+result+"</td><td align='center'><a href='"+path+"/FixedHandle?type=10&fixed_id="+obj[0]+"' class='a_del' onclick='return confirm(\"是否确认出场？\")'>设置出场</a></td></tr>");
	                		}
                		}
